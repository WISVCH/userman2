...
class AddUserForm(forms.Form):
    ...
    access = forms.MultipleChoiceField(initial=('samba@ank','samba@ch'), choices=(('sshd@ch', 'sshd@ch'),('samba@ank','samba@ank'), ('samba@ch', 'samba@ch'), ('sshd@ank', 'sshd@ank'), ('sshd@frans', 'sshd@frans')))
